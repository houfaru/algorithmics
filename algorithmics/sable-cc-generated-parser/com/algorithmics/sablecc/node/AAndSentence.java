...
public final class AAndSentence extends PSentence
{
    ...
    public AAndSentence(
        @SuppressWarnings("hiding") PSentence _left_,
        @SuppressWarnings("hiding") PSentence _right_)
    {
        // Constructor
        setLeft(_left_);
    ...
    {
        ((Analysis) sw).caseAAndSentence(this);
    }
